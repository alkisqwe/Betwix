...
public class moviessection extends Activity
{
	...
	public LinearLayout scrool17;
	public LinearLayout scrool18;
	public LinearLayout scrool19;
	...
	public Space fupspace;
	public Space gupspace;
	public Space hupspace;
	public hsv scroller;
	...
	public hsv scroller17;
	public hsv scroller18;
	public hsv scroller19;
	...
	public LinearLayout ffirst;
	public LinearLayout gfirst;
	public LinearLayout hfirst;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.moviessection);
		scrool = (LinearLayout)findViewById(R.id.scrolone);
		scrool2 = (LinearLayout)findViewById(R.id.scroltwo);
		scrool3 = (LinearLayout)findViewById(R.id.scrolthree);
		scrool4 = (LinearLayout)findViewById(R.id.scrolfour);
		scrool5 = (LinearLayout)findViewById(R.id.scrolfive);
		scrool6 = (LinearLayout)findViewById(R.id.scrolsix);
		scrool7 = (LinearLayout)findViewById(R.id.scrolseven);
		scrool8 = (LinearLayout)findViewById(R.id.scroleight);
		scrool9 = (LinearLayout)findViewById(R.id.scrolnine);
		scrool10 = (LinearLayout)findViewById(R.id.scrolten);
		scrool11 = (LinearLayout)findViewById(R.id.scroleleven);
		scrool12 = (LinearLayout)findViewById(R.id.scroltwelve);
		scrool13 = (LinearLayout)findViewById(R.id.scrolthreeteen);
		scrool14 = (LinearLayout)findViewById(R.id.scrolfourteen);
		scrool15 = (LinearLayout)findViewById(R.id.scrolfifteen);
		scrool16 = (LinearLayout)findViewById(R.id.scrolsixteen);
		scrool17 = (LinearLayout)findViewById(R.id.scrolseventeen);
		scrool18 = (LinearLayout)findViewById(R.id.scroleighteen);
		scrool19 = (LinearLayout)findViewById(R.id.scrolnineteen);
		...
		if(getResources().getBoolean(R.bool.is_landscape))
		{
			...
			fup = (ImageView)findViewById(R.id.fup);
			gup = (ImageView)findViewById(R.id.gup);
			hup = (ImageView)findViewById(R.id.hup);
			...
			fupspace = (Space)findViewById(R.id.fupspace);
			gupspace = (Space)findViewById(R.id.gupspace);
			hupspace = (Space)findViewById(R.id.hupspace);
			...
			scroller17 = (hsv)findViewById(R.id.scroller17);
			scroller18 = (hsv)findViewById(R.id.scroller18);
			scroller19 = (hsv)findViewById(R.id.scroller19);
			...
			if(scrool2 == null || scrool3 == null || scrool4 == null || scrool5 == null || scrool6 == null || scrool == null || scrool7 == null || scrool8 == null || scrool9 == null || scrool10 == null || scrool11 == null || scrool12 == null || scrool13 == null || scrool14 == null || scrool15 == null || scrool16 == null || scrool17 == null || scrool18 == null || scrool19 == null || famoustvtext == null || favtext == null || qtext == null || wtext == null || etext == null || rtext == null || ttext == null || ytext == null || utext == null || itext == null || otext == null || ptext == null || atext == null || stext == null || dtext == null || ftext == null || gtext == null || htext == null || movieup == null || favup == null || qup == null || wup == null || eup == null || rup == null || tup == null || yup == null || uup == null || iup == null || oup == null || pup == null || aup == null || sup == null || dup == null || fup == null || gup == null || hup == null || tvupspace == null || favupspace == null || qupspace == null || wupspace == null || eupspace == null || rupspace == null || tupspace == null || yupspace == null || uupspace == null || iupspace == null || oupspace == null || pupspace == null || aupspace == null || supspace == null || dupspace == null || fupspace == null || gupspace == null || hupspace == null)
			{
			...
			else
			{
				...
				scrool17.setVisibility(View.GONE);
				scrool18.setVisibility(View.GONE);
				scrool19.setVisibility(View.GONE);
				...
				fupspace.setVisibility(View.GONE);
				gupspace.setVisibility(View.GONE);
				hupspace.setVisibility(View.GONE);
			}
		...
		pd = new ProgressDialog(moviessection.this);
		pd.setMessage("Please wait");
		pd.setCancelable(false);
		pd.show();
		down = new ArrayList<>();
		MyTaskParams params = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=28&language=el-GR&page=1",scrool,"28",scroller,0);
		new json().execute(params);
		MyTaskParams params2 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=12&language=el-GR&page=1",scrool2,"12",scroller2,1);
		new json().execute(params2);
		MyTaskParams params3 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=16&language=el-GR&page=1",scrool3,"16",scroller3,2);
		new json().execute(params3);
		MyTaskParams params4 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=35&language=el-GR&page=1",scrool4,"35",scroller4,3);
		new json().execute(params4);
		MyTaskParams params5 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=80&language=el-GR&page=1",scrool5,"80",scroller5,4);
		new json().execute(params5);
		MyTaskParams params6 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=99&language=el-GR&page=1",scrool6,"99",scroller6,5);
		new json().execute(params6);
		MyTaskParams params7 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=18&language=el-GR&page=1",scrool7,"18",scroller7,6);
		new json().execute(params7);
		MyTaskParams params8 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=10751&language=el-GR&page=1",scrool8,"10751",scroller8,7);
		new json().execute(params8);
		MyTaskParams params9 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=14&language=el-GR&page=1",scrool9,"14",scroller9,8);
		new json().execute(params9);
		MyTaskParams params10 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=36&language=el-GR&page=1",scrool10,"36",scroller10,9);
		new json().execute(params10);
		MyTaskParams params11 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=27&language=el-GR&page=1",scrool11,"27",scroller11,10);
		new json().execute(params11);
		MyTaskParams params12 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=10402&language=el-GR&page=1",scrool12,"10402",scroller12,11);
		new json().execute(params12);
		MyTaskParams params13 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=9648&language=el-GR&page=1",scrool13,"9648",scroller13,12);
		new json().execute(params13);
		MyTaskParams params14 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=10749&language=el-GR&page=1",scrool14,"10749",scroller14,13);
		new json().execute(params14);
		MyTaskParams params15 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=878&language=el-GR&page=1",scrool15,"878",scroller15,14);
		new json().execute(params15);
		MyTaskParams params16 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=10770&language=el-GR&page=1",scrool16,"10770",scroller16,15);
		new json().execute(params16);
		MyTaskParams params17 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=53&language=el-GR&page=1",scrool17,"53",scroller17,16);
		new json().execute(params17);
		MyTaskParams params18 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=10752&language=el-GR&page=1",scrool18,"10752",scroller18,17);
		new json().execute(params18);
		MyTaskParams params19 = new MyTaskParams("https://api.themoviedb.org/3/discover/movie?with_genres=37&language=el-GR&page=1",scrool19,"37",scroller19,18);
		new json().execute(params19);
    }
	...
	public void navbuttons(boolean p2)
	{
		...
		else
		{
			...
			else
			{
				...
				else if(scrool17.getVisibility() == View.VISIBLE)
				{
					if(ffirst == null)
					{
				...
				else if(scrool18.getVisibility() == View.VISIBLE)
				{
					if(gfirst == null)
					{
				...
				else if(scrool19.getVisibility() == View.VISIBLE)
				{
					if(hfirst == null)
					{
	...
	public void favorites(View view)
	{
		...
		Intent intent = new Intent(moviessection.this, favorites.class);
	...
	public void tvref(View view)
	{
		...
		Intent intent = new Intent(moviessection.this, tvsection.class);
		startActivity(intent);
	}
	...
	public void search(View view)
	{
		...
		Intent intent = new Intent(moviessection.this, search.class);
		startActivity(intent);
	}
	
	public void movieref(View view)
	{
	...
	public void home(View view)
	{
		...
		Intent intent = new Intent(moviessection.this, MainActivity.class);
		startActivity(intent);
	}
	...
	private class json extends AsyncTask<MyTaskParams, String, String>
	{
					...
					try
					{
						if(i == 0)
						{
							if(getResources().getBoolean(R.bool.is_landscape))
							{
								...
								butt(obj.getString("title"),obj.getString("poster_path"),obj.getString("release_date"),obj.getString("id"),false,this.hiii,this.hi,this.hiiii,1,obj.getString("overview"),resultStringfin,obj.getString("backdrop_path"),this.hiiiiii);
								fir = 0;
							}
							else
							{
								hsv hsvv = new hsv(moviessection.this);
								butt(obj.getString("original_title"),obj.getString("poster_path"),obj.getString("release_date"),obj.getString("id"),false,this.hiii,this.hi,hsvv,1,obj.getString("overview"),"",obj.getString("backdrop_path"),this.hiiiiii);
								fir = 0;
							}
						}
						else
						{
							if(getResources().getBoolean(R.bool.is_landscape))
							{
								...
								String resultString = stringBuilder.toString();
								String resultStringfin = resultString.substring(0,resultString.length()-1);
								butt(obj.getString("title"),obj.getString("poster_path"),obj.getString("release_date"),obj.getString("id"),false,this.hiii,this.hi,this.hiiii,0,obj.getString("overview"),resultStringfin,obj.getString("backdrop_path"),this.hiiiiii);
								fir = 0;
							}
							else
							{
								hsv hsvv = new hsv(moviessection.this);
								butt(obj.getString("original_title"),obj.getString("poster_path"),obj.getString("release_date"),obj.getString("id"),false,this.hiii,this.hi,hsvv,0,obj.getString("overview"),"",obj.getString("backdrop_path"),this.hiiiiii);
								fir = 0;
							}
						}
					}
		...
		{
			Space spacer = new Space(moviessection.this);
		...
		public void butt(final String te,final String image,final String release,final String id,final boolean ok,final String gens,final LinearLayout lay,final hsv scrollersel,final int first,final String description, final String genres,final String backdrop,final int direction)
		{
			if(ok)
			{
				final LinearLayout one = new LinearLayout(moviessection.this);
				final LinearLayout textslay = new LinearLayout(moviessection.this);
				final ImageView two = new ImageView(moviessection.this);
				if(getResources().getBoolean(R.bool.is_landscape))
				{
					textslay.setOrientation(LinearLayout.VERTICAL);
					textslay.setBackgroundColor(Color.parseColor("#414141"));
					TextView three = new TextView(moviessection.this);
					TextView four = new TextView(moviessection.this);
					Space spacertwo = new Space(moviessection.this);
				...
				one.setOnClickListener(new OnClickListener()
					{
						public void onClick(View view)
						{
							...
							Intent intent = new Intent(moviessection.this, all.class);
							...
							else if(direction == 14)
							{
								if(p3.getKeyCode() == KeyEvent.KEYCODE_DPAD_DOWN && p3.getAction() == KeyEvent.ACTION_DOWN)
								{
									if(getResources().getBoolean(R.bool.is_landscape))
									{
										...
										fup.setBackgroundDrawable(getDrawable(R.drawable.down));
										gup.setVisibility(View.GONE);
										hup.setVisibility(View.GONE);
										tvupspace.setVisibility(View.GONE);
										favupspace.setVisibility(View.GONE);
										...
										supspace.setVisibility(View.GONE);
										dupspace.setVisibility(View.GONE);
										fupspace.setVisibility(View.VISIBLE);
										gupspace.setVisibility(View.GONE);
										hupspace.setVisibility(View.GONE);
										scrool.setVisibility(View.GONE);
										scrool2.setVisibility(View.GONE);
							...
							else if(direction == 15)
							{
								if(p3.getKeyCode() == KeyEvent.KEYCODE_DPAD_DOWN && p3.getAction() == KeyEvent.ACTION_DOWN)
								{
									if(getResources().getBoolean(R.bool.is_landscape))
									{
										...
										dup.setVisibility(View.GONE);
										fup.setVisibility(View.VISIBLE);
										fup.setBackgroundDrawable(getDrawable(R.drawable.up));
										gup.setVisibility(View.VISIBLE);
										gup.setBackgroundDrawable(getDrawable(R.drawable.down));
										hup.setVisibility(View.GONE);
										tvupspace.setVisibility(View.GONE);
										favupspace.setVisibility(View.GONE);
										qupspace.setVisibility(View.GONE);
										...
										dupspace.setVisibility(View.GONE);
										fupspace.setVisibility(View.GONE);
										gupspace.setVisibility(View.VISIBLE);
										hupspace.setVisibility(View.GONE);
										scrool.setVisibility(View.GONE);
										scrool2.setVisibility(View.GONE);
										scrool3.setVisibility(View.GONE);
										...
										scrool15.setVisibility(View.GONE);
										scrool16.setVisibility(View.GONE);
										scrool17.setVisibility(View.VISIBLE);
										scrool18.setVisibility(View.GONE);
										scrool19.setVisibility(View.GONE);
										famousmoviestext.setVisibility(View.GONE);
										famoustvtext.setVisibility(View.GONE);
							...
							else if(direction == 16)
							{
								if(p3.getKeyCode() == KeyEvent.KEYCODE_DPAD_DOWN && p3.getAction() == KeyEvent.ACTION_DOWN)
								{
									if(getResources().getBoolean(R.bool.is_landscape))
									{
										...
										fup.setVisibility(View.GONE);
										gup.setVisibility(View.VISIBLE);
										gup.setBackgroundDrawable(getDrawable(R.drawable.up));
										hup.setVisibility(View.VISIBLE);
										hup.setBackgroundDrawable(getDrawable(R.drawable.down));
										tvupspace.setVisibility(View.GONE);
										favupspace.setVisibility(View.GONE);
										qupspace.setVisibility(View.GONE);
										wupspace.setVisibility(View.GONE);
										...
										fupspace.setVisibility(View.GONE);
										gupspace.setVisibility(View.GONE);
										hupspace.setVisibility(View.VISIBLE);
										scrool.setVisibility(View.GONE);
										scrool2.setVisibility(View.GONE);
										scrool3.setVisibility(View.GONE);
										scrool4.setVisibility(View.GONE);
										...
										scrool16.setVisibility(View.GONE);
										scrool17.setVisibility(View.GONE);
										scrool18.setVisibility(View.VISIBLE);
										scrool19.setVisibility(View.GONE);
										famousmoviestext.setVisibility(View.GONE);
										famoustvtext.setVisibility(View.GONE);
										favtext.setVisibility(View.GONE);
							...
							else if(direction == 17)
							{
								if(p3.getKeyCode() == KeyEvent.KEYCODE_DPAD_DOWN && p3.getAction() == KeyEvent.ACTION_DOWN)
								{
									if(getResources().getBoolean(R.bool.is_landscape))
									{
										...
										gup.setVisibility(View.GONE);
										hup.setVisibility(View.VISIBLE);
										hup.setBackgroundDrawable(getDrawable(R.drawable.up));
										tvupspace.setVisibility(View.GONE);
										favupspace.setVisibility(View.GONE);
										qupspace.setVisibility(View.GONE);
										wupspace.setVisibility(View.GONE);
										...
										scrool17.setVisibility(View.GONE);
										scrool18.setVisibility(View.GONE);
										scrool19.setVisibility(View.VISIBLE);
										famousmoviestext.setVisibility(View.GONE);
										famoustvtext.setVisibility(View.GONE);
										favtext.setVisibility(View.GONE);
										qtext.setVisibility(View.GONE);
				...
				one.setOnClickListener(new OnClickListener()
					{
						public void onClick(View view)
						{
							...
							Intent intent = new Intent(moviessection.this, second.class);
